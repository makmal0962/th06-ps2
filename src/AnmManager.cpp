...
extern "C" { void pglBeginGeometry(); void pglEndGeometry(); void pglRenderGeometry(); }
#endif
...
#ifdef __PS2__
    printf("OpenPath done, ptr=%p\n", this->anmFiles[anmIdx]);
#endif
